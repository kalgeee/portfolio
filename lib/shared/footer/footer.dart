...
class _FooterState extends State<Footer> {
  ...
  void _updateTime() {
    ...
    final gmt0Time = utcNow;
    final formatter = DateFormat('h:mm a');
    setState(() {
      _jakartaTime = formatter.format(gmt7Time);
      _londonTime = formatter.format(gmt0Time);
    });
  }
  ...
  Widget _buildDesktopLayout(BuildContext context) => Row(
    ...
    children: [
      ...
      const Row(
        children: [
          _SocialIcon(icon: Icons.code, tooltip: 'GitHub', url: 'https://github.com/kalgeee'),
          SizedBox(width: 16),
          _SocialIcon(icon: Icons.work, tooltip: 'LinkedIn', url: 'https://www.linkedin.com/in/kalgee-joshi-7a0626348/'),
          SizedBox(width: 16),
        ],
      ),
    ],
