    ...
    return ClipRRect(
      child: BackdropFilter(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(color: Color(0xFF0D1117).withValues(alpha: 0.95)),
          child: Row(
                  ...
                  child: Image.asset(
                    ...
                    errorBuilder:
                        (context, error, stackTrace) => Container(
                          height: isSmallScreen ? 28 : 32,
                          width: 60,
                          color: Color(0xFF58A6FF).withValues(alpha: 0.1),
                          child: const Icon(Icons.image_not_supported, color:Color(0xFFF0F6FC), size: 16),
                        ),
                  ),
                ),
              ),
          ...
          builder:
              (context, child) => AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  color: _isHovering ? Color(0xFF58A6FF).withValues(alpha: 0.15) : Colors.transparent,
                  border: _isHovering ? Border.all(color: Color(0xFF58A6FF).withValues(alpha: 0.3)) : null,
                  boxShadow:
                      _isHovering
                          ? [
                            BoxShadow(
