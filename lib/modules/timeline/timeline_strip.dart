              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: isActive ? Color(0xFF58A6FF).withValues(alpha: 0.5) :Color(0xFF30363D),
                    boxShadow:
                        isActive
                            ? [
                              BoxShadow(
                              ...
                              BoxShadow(color:Color(0xFF58A6FF).withValues(alpha: 0.2), blurRadius: 12, spreadRadius: 2),
                            ]
                            : [
                              BoxShadow(
                                color: Color(0xFF58A6FF).withValues(alpha: 0.2),
                                blurRadius: 12,
                                spreadRadius: 2,
                              ),
                            ],
            ...
            Row(
              ...
              children: [
                if (!isLeft) ...[
                  Icon(
                    event.icon,
                    color: isActive ? Color(0xFF58A6FF) : Color(0xFF8B949E),
                ...
                Flexible(
                  child: Text(
                    ...
                    style: Theme.of(context).textTheme.titleSmall?.copyWith(
                      color: isActive ? AppColors.accent :Color(0xFF8B949E),
