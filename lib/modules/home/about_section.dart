...
class AboutSection extends StatelessWidget {
    ...
    children: [
      ScrollReveal(
        ...
        child: Text(
          ...
          style: Theme.of(
            context,
          ).textTheme.bodyLarge?.copyWith(color: Color(0xFF161B22), fontWeight: FontWeight.bold),
        ),
      ),
      ...
      ScrollReveal(
        ...
        child: Padding(
          ...
          child: AutoSizeText(
            "I'm Kalgee, an AI researcher and engineer specializing in uncertainty-aware multimodal systems. I bridge cutting-edge academic research with production-scale solutions, creating AI that not only performs exceptionally but also contributes to meaningful human progress.",
            style: Theme.of(
              context,
  ...
  Widget _buildStatsFooter(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(border: Border(top: BorderSide(color:Color(0xFF30363D)))),
      ...
      Row(
        ...
        children: [
          ScrollReveal(
            ...
            child: _buildStatItem(context, '3+', 'Years\nAI Research & Development'),
          ),
          ScrollReveal(
            delay: const Duration(milliseconds: 1150),
            duration: const Duration(milliseconds: 1200),
            child: _buildStatItem(context, '20+', 'Production Workflows\nAutomated'),
          ),
          ScrollReveal(
            delay: const Duration(milliseconds: 1200),
            duration: const Duration(milliseconds: 1200),
            child: _buildStatItem(context, '89%', 'Cross-Dataset Transfer\nRate Achieved'),
          ),
        ],
      ),
      ...
      Row(
        ...
        children: [
          ...
          ScrollReveal(
            ...
            duration: const Duration(milliseconds: 1200),
            child: _buildStatItem(context, '500+', 'Users Served in\nEnterprise Systems'),
          ),
          ScrollReveal(
            delay: const Duration(milliseconds: 1300),
            duration: const Duration(milliseconds: 1200),
            child: _buildStatItem(context, '∞', 'Problems Solved\nwith Code'),
          ),
          const SizedBox(width: 60), // Spacer for alignment
        ],
      ),
